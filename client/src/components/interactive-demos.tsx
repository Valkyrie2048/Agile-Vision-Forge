...
import {
  ...
  Bot, Target, Search as SearchIcon, Sparkles,
} from "lucide-react";
    ...
    <div data-testid="product-playground">
      <div className="flex gap-2 mb-6 flex-wrap">
        {demos.map((demo) => (
          ...
          >
            <demo.icon className="w-3.5 h-3.5 mr-1.5" />
            {demo.label}
          </Button>
        ))}
      </div>
      ...
      <div className="relative">
        <div className="rounded-lg border bg-background overflow-hidden shadow-lg" style={{ minHeight: 480 }}>
          <div className="flex items-center gap-2 px-3 py-2 bg-muted/50 border-b">
            ...
            <div className="flex-1 bg-background/80 rounded-sm px-3 py-1 text-xs text-muted-foreground truncate">
        ...
        <div className="absolute -inset-1 rounded-xl opacity-30 -z-10 blur-xl" style={{ background: "linear-gradient(135deg, hsl(250 85% 60% / 0.3), hsl(280 80% 60% / 0.2), hsl(250 85% 60% / 0.1))" }} />
      </div>
    </div>
  );
}
